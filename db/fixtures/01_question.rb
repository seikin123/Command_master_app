...
#Windows
 {id: 31, category_id: 1, synchro_key: 'Control', answer_key: 'c', problem: 'コピーする際のコマンド', display_key: 'Ctrl ←', pc_type: 1 },
 {id: 32, category_id: 1, synchro_key: 'Control', answer_key: 'a', problem: '全選択をする際のコマンド', pc_type: 1 },
