...
#Windows
 {id: 31, category_id: 1, synchro_key: 'Ctrl', answer_key: 'c', problem: 'コピーする際のコマンド', display_key: 'Ctrl + C', pc_type: 1, point: 10, problem_image: File.open("db/fixtures/category_images/vscode01.gif") },
 {id: 32, category_id: 1, synchro_key: 'Ctrl', answer_key: 'a', problem: '全選択をする際のコマンド', display_key: 'Ctrl + A', pc_type: 1, point: 10, problem_image: File.open("db/fixtures/category_images/vscode01.gif") },
 ...
 {id: 38, category_id: 1, synchro_key: 'Alt', answer_key: 'ArrowDown', problem: 'カーソル行／選択行をまるっと下移動(複数行対応)', display_key: 'Alt + ↓', pc_type: 1, problem_image: File.open("db/fixtures/category_images/vscode01.gif") },
 ...
 {id: 40, category_id: 1, synchro_key: 'Meta+Shift', answer_key: 'g', problem: 'ソース管理を開く', display_key: 'Ctrl + ︎Shift + G', pc_type: 1, problem_image: File.open("db/fixtures/category_images/vscode01.gif") },
